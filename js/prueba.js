...
function distribuirTarjetas(tarjetas, tarjetaElement) {
...
function eliminarTarjeta(idTarjeta, tarjetaElement) {
    ...
    console.log(`Enviando petición para eliminar id: ${idTarjeta}`);

    fetch("./php/eliminarTarjetas.php", { // Cambié la ruta
        method: "GET",
